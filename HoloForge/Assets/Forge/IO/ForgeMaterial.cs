...
public class LMVTexture {
	...
	public LMVTexture (JSONNode node ) {
		//Debug.Log (node) ;
		this.u =node ["properties"] ["scalars"] ["texture_UScale"] ["values"] [0].AsFloat ;
		...
		this.tex =node ["properties"] ["uris"] ["unifiedbitmap_Bitmap"] ["values"] [0] ;
...
public class ProteinMaterial {
	...
	private Color GetColor (JSONClass color) {
		return (new Color (
			color ["r"].AsFloat,
			color ["g"].AsFloat,
			color ["b"].AsFloat,
	...
	public virtual int hasAlbedo {
		get { return (   this.material ["properties"] ["colors"] ["surface_albedo"] != null
	...
	public virtual LMVTexture albedo {
	...
	public virtual int hasOpaqueAlbeto {
		get { return (   this.material ["properties"] ["colors"] ["opaque_albedo"] != null
	...
	public virtual LMVTexture opaqueAlbeto {
	...
	public virtual int hasRoughness {
		get { return (   this.material ["properties"] ["scalars"] ["surface_roughness"] != null
	...
	public virtual LMVTexture roughness {
	...
	public virtual int hasRotation {
		get { return (   this.material ["properties"] ["scalars"] ["surface_rotation"] != null
	...
	public virtual LMVTexture rotation {
	...
	public virtual int hasNormal {
		get { return (this.textures ["surface_normal"] != null ?
	...
	public virtual LMVTexture normal {
...
public class LMVMaterial {
	private JSONNode _json ;
	private ProteinMaterial _proteinJson ;

	public LMVMaterial (string jsonSt, string proteinJson) {
		try {
			_json =JSON.Parse (jsonSt) ;
			if ( proteinJson != null && proteinJson != "" )
	...
	public virtual LMVTexture diffuse_tex {
		get {
			if ( this.textures ["generic_diffuse"] == null )
				return (null) ;
			//Debug.Log (this.textures ["generic_diffuse"] ["connections"] [0]) ;
			JSONNode node =this.materials [this.textures ["generic_diffuse"] ["connections"] [0]] ;
			//Debug.Log (node);
			return (new LMVTexture (node)) ;
		}
	}

	public virtual LMVTexture specular_tex {
		get {
			if ( this.textures ["generic_specular"] == null )
				return (null) ;
			//Debug.Log (this.textures ["generic_diffuse"] ["connections"] [0]) ;
			JSONNode node =this.materials [this.textures ["generic_specular"] ["connections"] [0]] ;
			//Debug.Log (node);
			return (new LMVTexture (node)) ;
		}
	}

	public virtual LMVTexture bump_tex {
		get {
			if ( this.textures ["generic_bump"] == null )
				return (null) ;
			//Debug.Log (this.textures ["generic_diffuse"] ["connections"] [0]) ;
			JSONNode node =this.materials [this.textures ["generic_bump"] ["connections"] [0]] ;
			//Debug.Log (node);
			return (new LMVTexture (node)) ;
		}
	}
